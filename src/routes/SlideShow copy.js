...
<div className='xl-position-relative xl-width100 xl-display-flex xl-justifyContent-center xl-alignItems-center xl-overflow-hidden'>
    ...
    <div className='xl-position-absolute xl-width100 xl-height-60xl-display-flex xl-justifyContent-between xl-position-absolute'>
        <button className='xl-paddingR-15 xl-paddingT-10 xl-paddingL-15 xl-paddingB-10 xl-pointer xl-bg-blur1 xl-borderR-15 xl-color-black xl-display-flex xl-justifyContent-center xl-alignItems-center xl-marginL-10'
         onClick={()=>{
            if( counter>0 ){ counter-- }
            else{ counter=bannerArray.length-1 }
            setFlag(counter);
        }}>

        <i className="bi bi-caret-left-fill xl-fontSize-26"></i></button>
        <button className='xl-paddingR-15 xl-paddingT-10 xl-paddingL-15 xl-paddingB-10 xl-pointer xl-bg-blur1 xl-borderR-15 xl-color-black xl-display-flex xl-justifyContent-center xl-alignItems-center xl-marginR-10' 
        onClick={()=>{
            if( counter>0 ){ counter++ }
            else{ counter=bannerArray.length-1 }
            setFlag(counter);
